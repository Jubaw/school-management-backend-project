...
public class StudentInfoController {
    ...
    public ResponseMessage<StudentInfoResponse> saveStudentInfo(@RequestBody @Valid StudentInfoRequest studentInfoRequest, HttpServletRequest httpServletRequest) {
...
// Not : ( ODEV )  Delete() ************************************************************
    ...
    @GetMapping("/getAllStudentInfoByPage")// http://localhost:8080/studentInfo/getAllStudentInfoByPage?pa
...
// Not: ( ODEV ) Update() ************************************************************* student info
@PreAuthorize("hasAnyAuthority('ADMIN','TEACHER')")
@PutMapping("/delete/{studentInfoId}") // http://localhost:8080/studentInfo/update/1
