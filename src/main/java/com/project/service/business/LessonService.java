...
public class LessonService {
    ...
    private boolean isLessonExistByLessonName(String lessonName){
        ...
        if(lessonExist){
            throw new ConflictException(String.format(ErrorMessages.ALREADY_EXISTS_WITH_LESSON_NAME, lessonName));
        } else return false;
    }
    ...
    public LessonResponse updateLessonById(Long lessonId, LessonRequest lessonRequest) {
        ...
        if(
            ...
            throw new ConflictException(String.format(ErrorMessages.ALREADY_EXISTS_WITH_LESSON_NAME, lessonRequest.getLessonName()));
        }
